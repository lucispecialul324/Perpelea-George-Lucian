...
<html>
    <head>
        ...
        <title>Catalog Scolar - Autentificare Profesor</title>
        <link rel="stylesheet" href="Style.css">
    </head>
    <body>
        <div class="main-container">
            <h1><center><b>Autentificare Profesor</b></center></h1>
            <p>Vă rugăm introduceți datele de acces pentru a gestiona catalogul.</p>
            ...
            <form action="login.php" method="POST">
                <fieldset>
                    <legend>Date de Login Profesor</legend>
                    
                    <label for="username">Nume Utilizator:</label><br>
                    <input type="text" id="username" name="username" required placeholder="Ex: prof.mate"><br><br>
